	...
	public void selectBrowser(String browser) {
		...
		if (System.getProperty("os.name").contains("Window")) {
			if (browser.equals("chrome")) {
				...
				System.out.println(System.getProperty("user.dir"));
				System.setProperty("webdriver.gecko.driver", System.getProperty("user.dir") + "/PageObjectWithPageFactoryFramework-master/drivers/geckodriver.exe");
			...
			if (browser.equals("chrome")) {
				System.out.println(System.getProperty("user.dir"));
				System.setProperty("webdriver.chrome.driver", System.getProperty("user.dir") + "/PageObjectWithPageFactoryFramework-master/drivers/geckodriver.exe");
				driver = new ChromeDriver();
				// driver = new EventFiringWebDriver(dr);
				// eventListener = new WebEventListener();
				// driver.register(eventListener);
